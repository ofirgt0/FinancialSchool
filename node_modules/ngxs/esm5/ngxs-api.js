...
var Store = /** @class */ (function () {
    ...
    Store.prototype.dispatch = function (event) {
        ...
        if (Array.isArray(event)) {
            result = forkJoin(event.map(function (a) { return _this._dispatch(a); }));
        }
        else {
            result = this._dispatch(event);
        }
        result.pipe(catchError(function (err) {
...
var NGXS_LOCAL_STORAGE_PLUGIN_OPTIONS = new InjectionToken('NGXS_LOCAL_STORAGE_PLUGIN_OPTION');
